...
const Home = () => {
  return (
    <div
      name="home"
      className="h-full pt-20 w-full bg-gradient-to-b
      ...
      >
        <div className="flex flex-col justify-center h-full py-6">
          ...
          <p className="text-gray-500 py-4 max-w-md">
            I am a Front-end web developer with 20+ months of experience at
            Cognizant. Skilled in HTML, CSS, JavaScript, React JS framework and
